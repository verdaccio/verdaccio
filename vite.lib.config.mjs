 ...
 * and source maps. Type declarations are emitted separately with
 * `tsc --emitDeclarationOnly` (TypeScript 7 native compiler).
...
export function createLibConfig(dirname, options = {}) {
  ...
  return defineConfig({
    plugins: [copyStaticFiles(path.resolve(dirname, 'src'), path.resolve(dirname, outDir))],
    build: {
      outDir,
      emptyOutDir: true,
      sourcemap: true,
