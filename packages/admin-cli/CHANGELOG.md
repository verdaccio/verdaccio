...
- 34cd0fb: feat(admin-cli): new `@verdaccio/admin-cli` package with an experimental `verdaccio-admin storage` command group
...
- 8c21fa8: fix(admin-cli): test on windows
