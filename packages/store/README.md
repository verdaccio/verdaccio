# @verdaccio/store - Verdaccio Storage
...
[![This Package Latest](https://img.shields.io/npm/v/@verdaccio/store?label=@verdaccio/store&color=405236)](https://npmjs.com/package/@verdaccio/store)
