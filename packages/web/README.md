# @verdaccio/web - Verdaccio Web Middleware
...
[![This Package Latest](https://img.shields.io/npm/v/@verdaccio/web?label=@verdaccio/web&color=405236)](https://npmjs.com/package/@verdaccio/web)
