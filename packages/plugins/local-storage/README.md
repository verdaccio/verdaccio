# @verdaccio/local-storage - Verdaccio Local Storage Plugin
...
[![This Package Latest](https://img.shields.io/npm/v/@verdaccio/local-storage?label=@verdaccio/local-storage&color=405236)](https://npmjs.com/package/@verdaccio/local-storage)
