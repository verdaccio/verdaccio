...
module.exports = function(config, auth, storage) {
  ...
  app.get('/-/search/:anything', function(req, res, next) {
    ...
    storage.lsearch(req.params.anything, function (err, result){
    	if (err)
    		next([]);
    	else
    		next(result);
...
// Will be using the Lucene search above ... no caching.  Caching does not works when we have muliple instances
//
