...
* [verdaccio-aws-s3-storage](https://github.com/verdaccio/monorepo/tree/9.x/plugins/aws-s3-storage) Storage plugin to host packages **Amazon S3** (maintained by Verdaccio core team)
