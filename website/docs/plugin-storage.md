...
* [verdaccio-aws-s3-storage](https://github.com/verdaccio/verdaccio/tree/master/packages/plugins/aws-storage) Storage plugin to host packages **Amazon S3** (maintained by Verdaccio core team)
