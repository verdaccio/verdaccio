# Verdaccio 7 with local storage volume

This example shows a minimal `verdaccio/verdaccio:7.x-next` setup that persists
the default file storage and configuration through bind-mounted volumes.
...
2. Pull the verdaccio image `docker pull verdaccio/verdaccio:7.x-next`
3. Tag the docker image for the app: `docker tag verdaccio/verdaccio:7.x-next dokku/verdaccio:v1`
